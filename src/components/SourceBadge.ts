...
const SOURCE_STYLES: Record<Source, string> = {
  ...
  stacksbowers:     'bg-purple-900/60 text-purple-300 border-purple-700',
  greatcollections: 'bg-green-900/60  text-green-300  border-green-700',
}
