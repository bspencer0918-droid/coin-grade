...
_CATEGORY_PATTERNS: list[tuple[re.Pattern, Category]] = [
    (re.compile(r'\bbyzantin\b|\bconstantinople\b|\bsolidus\b|\bfollis\b|\bnomisma\b', re.I), Category.BYZANTINE),
    (re.compile(r'\broman\b|\brome\b|\bimperial\b|\brepublic\b|\bdenarius\b|\baureus\b|\bsestertius\b', re.I), Category.ROMAN),
    (re.compile(r'\bgreek\b|\bathens\b|\bcorinth\b|\bsparta\b|\btetradrachm\b|\bdrachm\b|\bstater\b|\battica\b', re.I), Category.GREEK),
    (re.compile(r'\bpersian\b|\bachemenid\b|\bdarius\b|\bxerxes\b|\bsigloi\b|\bdaric\b', re.I), Category.PERSIAN),
    (re.compile(r'\bcelt\b|\bgaul\b|\bbritish\b|\bpotin\b|\bbiga\b', re.I),                   Category.CELTIC),
